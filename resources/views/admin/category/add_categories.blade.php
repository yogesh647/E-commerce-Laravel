                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" method="post" action="{{url('/admin/add_categories')}}" > {{csrf_field()}}
                              ...
                              <div class="form-group">
                                 <label>URL</label>
                                 <input type="text" class="form-control" name="category_url" placeholder="Enter Category url" required>
                              </div>
							  <div class="form-group">
